...
def login():
    ...
    if user=="Parvat" and code=="1234":
        ...
        Label(f, font=("Lucida Calligraphy", 15, "bold"), text="Sandwich.....Rs.60/plate", fg="black",
            bg="lightgreen").place(x=10, y=80)
        Label(f, font=("Lucida Calligraphy", 15, "bold"), text="Cookies.....Rs.30/plate", fg="black",
            bg="lightgreen").place(x=10, y=110)
        Label(f, font=("Lucida Calligraphy", 15, "bold"), text="Tea.....Rs.7/cup", fg="black", bg="lightgreen").place(x=10,
                                                                                                                  y=140)
        Label(f, font=("Lucida Calligraphy", 15, "bold"), text="Coffee.....Rs.100/cup", fg="black", bg="lightgreen").place(
            x=10, y=170)
        Label(f, font=("Lucida Calligraphy", 15, "bold"), text="Juice.....Rs.20/glass", fg="black", bg="lightgreen").place(
            x=10, y=200)
        Label(f, font=("Lucida Calligraphy", 15, "bold"), text="Pancakes.....Rs.15/pack", fg="black",
            bg="lightgreen").place(x=10, y=230)
        Label(f, font=("Lucida Calligraphy", 15, "bold"), text="Pastery.....Rs.25/pastery", fg="black",
        ...
        entry_sandwich = Entry(f1, font=("arial", 20, "bold"), textvariable=sandwich, bd=6, width=8, bg="light pink")
        entry_cookies = Entry(f1, font=("arial", 20, "bold"), textvariable=cookies, bd=6, width=8, bg="light pink")
        entry_tea = Entry(f1, font=("arial", 20, "bold"), textvariable=tea, bd=6, width=8, bg="light pink")
        entry_coffee = Entry(f1, font=("arial", 20, "bold"), textvariable=coffee, bd=6, width=8, bg="light pink")
        entry_juice = Entry(f1, font=("arial", 20, "bold"), textvariable=juice, bd=6, width=8, bg="light pink")
        entry_pancakes = Entry(f1, font=("arial", 20, "bold"), textvariable=pancakes, bd=6, width=8, bg="light pink")
        entry_pastery = Entry(f1, font=("arial", 20, "bold"), textvariable=pastery, bd=6, width=8, bg="light pink")
        ...
        message.showerror("Invalid","password is required")
...
def main_screen():
    ...
    image_icon = PhotoImage(file="login_img.png")
    screen.iconphoto(False, image_icon)

    IbITitle = Label(screen, text="Login System",
                     font=("Arial", 50, "bold"),
                     fg="black",
                     bg="#d7dae2")
